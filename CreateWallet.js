...
// 1. FORM VALIDATION — Save My Wallet
...
if (saveBtn) {
    saveBtn.addEventListener('click', (e) => {
        ...
        if (!/^@?[a-zA-Z0-9_]{3,}$/.test(username)) {
            showToast('Username must be 3+ characters (letters, numbers, _)', 'error');
            usernameInput.focus();
            usernameInput.classList.add('border-error');
            return;
        }
        ...
        // All good — navigate
        showToast('Wallet created successfully!', 'success', 1500);
...
// 5. ANIMATED SPINNING RING — Pause on Hover
